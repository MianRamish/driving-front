...
export default function Lessons() {
  ...
  const submit = async (e) => {
    ...
    setError('');
    try {
      await api.post('/lessons', { ...form, instructor: isAdmin ? form.instructor : user?._id });
  ...
  return (
    <div className="page">
      ...
      {(isAdmin || isInstructor) && showForm && (
        <div className="sheet-backdrop" onClick={(e) => { if (e.target === e.currentTarget) setShowForm(false); }}>
