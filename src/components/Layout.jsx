...
<<<<<<< HEAD
          ...
          <div>
            <strong>DriveSmart</strong>
            <span>School Manager</span>
          </div>
          <button className="icon-btn mobile-only" onClick={close} aria-label="Close menu">
            <X size={20} />
          </button>
        </div>

        <nav className="nav">
          <NavLink onClick={close} className={linkClass} to="/" end>
            <LayoutDashboard size={18} /> Dashboard
          </NavLink>
          <NavLink onClick={close} className={linkClass} to="/students">
            <GraduationCap size={18} /> Students
          </NavLink>
          {isAdmin && (
            <NavLink onClick={close} className={linkClass} to="/instructors">
              <Users size={18} /> Instructors
            </NavLink>
          )}
          <NavLink onClick={close} className={linkClass} to="/availability">
            <Clock3 size={18} /> Availability
          </NavLink>
          <NavLink onClick={close} className={linkClass} to="/lessons">
            <CalendarDays size={18} /> Lessons
          </NavLink>
=======
...
<<<<<<< HEAD
          ...
          <div>
            ...
            <p>Manage students, instructors, availability and lessons.</p>
          </div>
=======
